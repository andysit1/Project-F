...
class Segments():
    ...
    def shift_segment(self, point : pygame.Vector2):
        ...
        self.start = pygame.Vector2(self.start.x + diff.x, self.start.y + diff.y)
        self.end = pygame.Vector2(self.end.x + diff.x, self.end.y + diff.y)
